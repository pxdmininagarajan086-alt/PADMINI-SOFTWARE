    ...
    <div className="create-invoice-page animate-fade-in">
      <div className="page-header flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          <button className="icon-btn" onClick={() => navigate('/invoices')}>
            <ArrowLeft size={20} />
          </button>
          <div>
            <h1>Create New Invoice</h1>
            <p className="text-secondary">INV-{new Date().getFullYear()}-{Math.floor(Math.random() * 10000).toString().padStart(4, '0')}</p>
          </div>
        </div>
          ...
          <div className="glass-panel">
            ...
            <div className="grid-2-col gap-4">
              ...
              <div className="input-group">
                ...
                <input type="email" className="input-field" placeholder="billing@acmecorp.com" />
              </div>
